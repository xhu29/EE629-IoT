...
def runController(Ro_alcohol, Ro_methane, Ro_butane, Ro_CO, Ro_H2S):
    ...
    Rs_methane = RL_methane_butane_H2S * (4.99 * 1023 / Vout_methane - 1)
    Rs_butane = RL_methane_butane_H2S * (4.99 * 1023 / Vout_butane - 1)
    Rs_CO = RL_CO * (4.99 * 1023 / Vout_CO - 1)
    Rs_H2S = RL_methane_butane_H2S * (4.99 * 1023 / Vout_H2S - 1)
...
while True:
    ...
    try:
        Alcohol_test, Methane_test, Butane_test, CO_test, H2S_test = runController(Ro_alcohol, Ro_methane, Ro_butane, Ro_CO, Ro_H2S)
